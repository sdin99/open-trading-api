...
def get_domestic_eurex_option_master_dataframe(base_dir):
    ...
    df1 = pd.read_csv(tmp_fil1, header=None, names=part1_columns, encoding='utf-8', sep='\t')
    ...
    df2 = pd.read_csv(tmp_fil3, header=None, names=part2_columns, encoding='utf-8', sep='\t')
